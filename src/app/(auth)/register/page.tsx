      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-4">
            {[
              { step: "01", title: "Create your account", desc: "Free to join. No payment required." },
              { step: "02", title: "Pick a match", desc: "Browse upcoming cricket and basketball matches." },
              { step: "03", title: "Build your team", desc: "Select players and submit before the match starts." },
            ].map((item) => (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm">
              Free to join. No payment required. Start building teams today.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              />
              <p className="text-xs text-gray-400 mt-1.5">Letters, numbers, and underscores only. 3–30 characters.</p>
            </div>
